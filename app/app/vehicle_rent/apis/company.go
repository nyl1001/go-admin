...
func (e Companies) GetPage(c *gin.Context) {
	req := dto.CompaniesQueryReq{}
	s := service.Companies{}
	err := e.MakeContext(c).
		MakeOrm().
		Bind(&req).
...
func (e Companies) GetAll(c *gin.Context) {
	s := service.Companies{}
	err := e.MakeContext(c).
		MakeOrm().
		MakeService(&s.Service).
...
func (e Companies) Get(c *gin.Context) {
	req := dto.CompaniesGetReq{}
	s := service.Companies{}
	err := e.MakeContext(c).
		MakeOrm().
		Bind(&req).
...
func (e Companies) Insert(c *gin.Context) {
	req := dto.CompaniesInsertReq{}
	s := service.Companies{}
	err := e.MakeContext(c).
		MakeOrm().
		Bind(&req).
...
func (e Companies) Update(c *gin.Context) {
	req := dto.CompaniesUpdateReq{}
	s := service.Companies{}
	err := e.MakeContext(c).
		MakeOrm().
		Bind(&req).
...
func (e Companies) Delete(c *gin.Context) {
	s := service.Companies{}
	req := dto.CompaniesDeleteReq{}
	err := e.MakeContext(c).
		MakeOrm().
		Bind(&req).
		MakeService(&s.Service).
...
func (e Companies) Export(c *gin.Context) {
	req := dto.CompaniesQueryReq{}
	s := service.Companies{}
	err := e.MakeContext(c).
		MakeOrm().
	...
	fileName := "companies_" + dateutils.ConvertToStr(time.Now(), 3) + ".xlsx"
	e.DownloadExcel(fileName, data)
}

// Get2Tree 车辆管理 公司树
func (e Companies) Get2Tree(c *gin.Context) {
	s := service.Companies{}
	req := dto.CompaniesQueryReq{}
	err := e.MakeContext(c).
		MakeOrm().
	...
	list := make([]dto.CompaniesLabel, 0)
	list, respCode, err := s.SetCompanyTree(&req)
	if err != nil {
		e.Error(respCode, err.Error())
		return
	}
