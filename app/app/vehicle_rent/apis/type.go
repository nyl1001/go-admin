...
//
// GetPage
// @Description: 获取车辆种类列表

func (e VehicleType) GetPage(c *gin.Context) {
	req := dto.VehicleTypeQueryReq{}
...
func (e VehicleType) Get(c *gin.Context) {
	req := dto.VehicleTypeGetReq{}
	s := service.VehicleType{}
	err := e.MakeContext(c).
		MakeOrm().
		Bind(&req).
...
func (e VehicleType) Insert(c *gin.Context) {
	req := dto.VehicleTypeInsertReq{}
	s := service.VehicleType{}
	err := e.MakeContext(c).
		MakeOrm().
		Bind(&req).
...
func (e VehicleType) Update(c *gin.Context) {
	req := dto.VehicleTypeUpdateReq{}
	s := service.VehicleType{}
	err := e.MakeContext(c).
		MakeOrm().
		Bind(&req).
...
func (e VehicleType) Delete(c *gin.Context) {
	s := service.VehicleType{}
	req := dto.VehicleTypeDeleteReq{}
	err := e.MakeContext(c).
		MakeOrm().
		Bind(&req).
		MakeService(&s.Service).
...
func (e VehicleType) Export(c *gin.Context) {
	req := dto.VehicleTypeQueryReq{}
	s := service.VehicleType{}
	err := e.MakeContext(c).
		MakeOrm().
	...
	fileName := "type_" + dateutils.ConvertToStr(time.Now(), 3) + ".xlsx"
